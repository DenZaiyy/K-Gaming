...
window.addEventListener("load", (e) => {
    ...
    if (plateform) {
        ...
        plateform.addEventListener("change", function (e) {
            ...
            let idPlatform = plateform.value; // on récupère la valeur de l'élément
            ...
            /*if (lang === "fr") {
                window.location.href = "/" + lang + "/plateforme/" + category + "/" + idPlatform + "/" + idGame; // on redirige vers la page avec l'id de la plateforme et du jeu
            } else {
                window.location.href = "/" + lang + "/platform/" + category + "/" + idPlatform + "/" + idGame; // on redirige vers la page avec l'id de la plateforme et du jeu
            }*/
            window.location.href = "/" + lang + "/platform/" + category + "/" + idPlatform + "/" + idGame; // on redirige vers la page avec l'id de la plateforme et du jeu

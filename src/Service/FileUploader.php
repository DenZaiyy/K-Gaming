...
class FileUploader
{
    ...
    public function upload (UploadedFile $file): string
    {
        ...
        $safeFilename = hash(
          "md5", $this->slugger->slug($originalFilename)
        ); // permet de sécuriser le nom du fichier en le hashant avec md5 et en le slugifiant avec le slugger de symfony (pour éviter les caractères spéciaux)

    ...
    public function buildForm (FormBuilderInterface $builder, array $options): void
    {
        $builder->add("username", TextType::class, ["required" => true,
          ...
          "attr" => ["placeholder" => "Pseudo",
            "class" => "form-control",],])->add("email", EmailType::class, ["required" => true,
          "label" => "Email",
          "attr" => ["placeholder" => "Email", "class" => "form-control",],
          "constraints" => [new Email(["message" => "Veuillez entrer un email valide.",]),
            new NotBlank(["message" => "Veuillez entrer un email.",]),],])->add(
          "plainPassword", RepeatedType::class, ["mapped" => false,
          ...
          "second_options" => ["label" => "Confirmer votre mot de passe",
            "attr" => ["placeholder" => "Confirmer votre mot de passe", "class" => "form-control",],],
          ...
          "constraints" => [new IsTrue(["message" => "Vous devez accepter nos conditions générales.",]),],]);
    }

...
class DashboardController extends AbstractDashboardController
{
    ...
    {
        return Dashboard::new()->setTitle("K-Gaming")->renderContentMaximized()->setTranslationDomain(
          "admin"
        )->setLocales(["fr",
          "en"]);
    }
    ...
    {
        return [MenuItem::linkToRoute(new TranslatableMessage("menu.back_home", [], "admin"), "fas fa-home", "app_home"
        ),

          MenuItem::section(new TranslatableMessage("menu.game.index", [], "admin")),
          MenuItem::linkToCrud(new TranslatableMessage("menu.game.index", [], "admin"), "fa-solid fa-gamepad",
            Game::class),
          MenuItem::linkToCrud(new TranslatableMessage("menu.game.gender", [], "admin"), "fa-solid fa-icons",
            Genre::class),
          MenuItem::linkToCrud(new TranslatableMessage("menu.game.rating", [], "admin"), "fa-solid fa-star",
            Rating::class),
          ...
          MenuItem::linkToCrud(new TranslatableMessage("menu.store.users.index", [], "admin"), "fa-solid fa-user-gear",
            User::class),
          MenuItem::linkToCrud(new TranslatableMessage("menu.store.orders", [], "admin"), "fa-solid fa-laptop",
            Purchase::class),
          MenuItem::linkToCrud(new TranslatableMessage("menu.store.stocks", [], "admin"), "fa-solid fa-shop",
            Stock::class),

          MenuItem::section(new TranslatableMessage("menu.marketing.index", [], "admin")),
          MenuItem::linkToCrud(new TranslatableMessage("menu.marketing.newsletter", [], "admin"),
            "fa-solid fa-paper-plane", Newsletter::class),
          MenuItem::linkToCrud(new TranslatableMessage("menu.marketing.registered_users", [], "admin"),
            "fa-solid fa-users-gear", NewsletterUser::class),

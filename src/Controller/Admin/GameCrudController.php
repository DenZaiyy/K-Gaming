...
class GameCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular(fn(?Game $product, ?string $pageName) => $product
                ? $product->getLabel()
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield NumberField::new("id", new TranslatableMessage("game.table.id", [], "admin"))
            ->hideOnForm();
        ...
        yield SlugField::new("slug", new TranslatableMessage("game.table.slug", [], "admin"))
            ->setTargetFieldName("label");
        yield FormField::addColumn(4);
        yield FormField::addPanel(new TranslatableMessage("game.detail.status", [], "admin"))
            ->setHelp(new TranslatableMessage("game.detail.status_description", [], "admin"));
        ...
        yield MoneyField::new("price", new TranslatableMessage("game.table.price", [], "admin"))
            ->setCurrency("EUR")
            ->setStoredAsCents(false);
        yield MoneyField::new("old_price", new TranslatableMessage("game.table.old_price", [], "admin"))
            ->setCurrency("EUR")
            ->setDisabled(true)
            ->hideOnIndex();
        yield FormField::addColumn(4);
        ...
        yield FormField::addPanel()
            ->setHelp(new TranslatableMessage("game.detail.game_genders_description", [], "admin"));
        ...
        yield DateField::new("date_release", new TranslatableMessage("game.table.release_date", [], "admin"))

...
class StockCrudController extends AbstractCrudController
{
    ...
    {
        return $crud->setEntityLabelInSingular("Game Stock")->setEntityLabelInPlural("Game Stock")->setSearchFields(
          ["id",
            "game_id",
            "purchase_id",
            "plateform_id",
            ...
            "date_availability",
            "is_available",]
        )->setDefaultSort(["date_availability" => "DESC"])->setPaginatorPageSize(10)->setEntityPermission(
          "ROLE_EDITOR"
    ...
    {
        return $filters->add(EntityFilter::new("game"))->add(EntityFilter::new("purchase"))->add(
          EntityFilter::new("plateform")
        )->add("is_available")->add("date_availability");
    }

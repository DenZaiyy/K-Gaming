    ...
    public function register (
      ...
      MultiAvatars $avatar
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $checkMail = $entityManager->getRepository(User::class)->findOneBy(
            ...
            $user->setPassword($userPasswordHashed->hashPassword($user, $form->get("plainPassword")->getData()));
            ...
            $this->emailVerifier->sendEmailConfirmation(
              ...
              (new TemplatedEmail())->from(new Address("support@k-grischko.fr", "K-Gaming - Support"))->to(
                $user->getEmail()
              )->subject("Confirmer votre email")->htmlTemplate("security/registration/confirmation_email.html.twig")
            );
        ...
        return $this->render("security/registration/register.html.twig", ["registrationForm" => $form->createView(),

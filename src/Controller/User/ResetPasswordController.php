...
class ResetPasswordController extends AbstractController
{
  ...
  public function request(
    ...
    return $this->render("security/reset_password/request.html.twig", [
      ...
      "description" =>
        "Vous avez oublié votre mot de passe ? Pas de problème, veuillez saisir votre adresse email et nous vous enverrons un lien pour réinitialiser votre mot de passe.",
    ]);
  }
    ...
    $email = (new TemplatedEmail())
      ->from(
        new Address(
          ...
          "K-GAMING - Réinitialiser le mot de passe"
        )
      )
      ->to($user->getEmail())

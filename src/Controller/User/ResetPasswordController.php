...
class ResetPasswordController extends AbstractController
{
    ...
    public function request (Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        return $this->render("security/reset_password/request.html.twig", ["requestForm" => $form->createView(),
          "description" => "Vous avez oublié votre mot de passe ? Pas de problème, veuillez saisir votre adresse email et nous vous enverrons un lien pour réinitialiser votre mot de passe.",]
        );
    }
    ...
    private function processSendingPasswordResetEmail (
      ...
      TranslatorInterface $translator
        ...
        $email = (new TemplatedEmail())->from(
          new Address("support@k-grischko.fr", "K-GAMING - Réinitialiser le mot de passe")
        )->to($user->getEmail())->subject("Votre demande de réinitialisation du mot de passe")->htmlTemplate(
    ...
    public function reset (
      ...
      string $token = null
        ...
        return $this->render("security/reset_password/reset.html.twig", ["resetForm" => $form->createView(),
          "description" => null,]);
    }
}
